...
Level.prototype.create = function () {
	...
	var _text = this.add.text(6, 591, 'Use left and right arrow keys to move.', {"font":"bold 20px Arial"});
	_text.scale.setTo(0.9378092100602295, 1.1502605313212921);
	
	var _text1 = this.add.text(1078, 775, 'Use up arrow to jump', {"font":"bold 20px Arial"});
